...
public class CommonValue {
    ...
    public final static Store TEST_STORE = new Store(1L,"name","storeAddress","storeNumber",10000, LocalTime.of(9,0),LocalTime.of(21,0), StoreStatus.OPEN);
    public final static Store TEST_STORE2 = new Store(1L,"name","storeAddress","storeNumber",10000,LocalTime.of(9,0),LocalTime.of(21,0), StoreStatus.CLOSED);
